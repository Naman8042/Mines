...
import Mines from "./_component/Mines"
...
const page = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row px-[5%] justify-center items-center md:justify-start md:items-start md:px-[10%] py-[3.5%] bg-gray-600 h-screen ">
