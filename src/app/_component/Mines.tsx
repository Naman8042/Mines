        ...
        {diamonds.map((item, index) => (
          included.includes(index) ? (
            <div
              key={index}
              onClick={addAll}
              className="bg-gray-800 flex justify-center items-center rounded-xl w-32 h-32"
            >
              {item === 'diamond' ? (
            ...
            <div
              ...
              className="bg-gray-500 h-32 w-32 hover:-translate-y-1 rounded-xl"
            >
              <div className="bg-gray-400 hover:bg-gray-200 w-32 shadow-2xl h-[93%] rounded-xl" />
              <div className="h-[7%]" />
            </div>
          )
        ))}
